    ...
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-6">
        <div class="inline-flex items-center justify-center mb-3">
          <img src="/LOGO2.png" alt="CAP Pacifico" class="h-32 w-auto" style="filter: drop-shadow(0 0 18px rgba(255,255,255,1)) drop-shadow(0 0 35px rgba(255,255,255,0.75)) drop-shadow(0 4px 14px rgba(255,255,255,0.5));" />
        </div>
